...
$.card2.states.add
	...
	three:  x: -510, y: 300, scale: 0.85, originX: 1, originY: 0, z: 2
$.card2.states.animationOptions = curve: "spring(200, 20, 0)"

$.card3.states.add
	two: scale: 0.85, x: 700, y: 300, originX: 0, originY: 0 z: 2
	three: scale: 1, x: 94, y: 268, originX: 0, originY: 0, z: 3
